...
local ConfigFolder = "NoMercyConfigs"
...
function NoMercy:CreateWindow(config)
    config = config or {}
    local Title = config.Title or "NO MERCY HUB"
    ...
    CreateParagraph(ConfigTabContainer, "Note", "Configs are saved to local files in the NoMercyConfigs folder.")
